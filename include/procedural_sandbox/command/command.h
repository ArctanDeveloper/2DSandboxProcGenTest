...
namespace ProceduralSandbox::Command {
    ...
    typedef std::tuple<ParameterType, bool> ParameterValue;
}
...
namespace ProceduralSandbox::Command {
    ...
    struct Command {
        ...
        std::vector<ParameterValue> parameters; ///< The parameters of the command.
         ...
         */
        void AddParameter(ParameterType param, bool required);

        bool IsValid(std::string initializer, const std::vector<Parameter>& parameters);
